...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <div class="newshop">
          <h1 style="font-family: Poppins, sans-serif;"><c:out value="${product.name}"/></h1>
	<h4>Edit Product</h4>
	<p><form:errors class="errors" path="product.*"/></p>
     	<form:form method="POST" action="/products/edit/${product.id}" modelAttribute="product">
