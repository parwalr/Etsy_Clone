...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <div class="newshop">
          <h1 style="font-family: Poppins, sans-serif;"><c:out value="${store.name}"/></h1>
	<h4>Edit Store</h4>
	<p><form:errors class="errors" path="store.*"/></p>
     	<form:form method="POST" action="/stores/edit/${store.id}" modelAttribute="store">
	    <input type="hidden" name="_method" value="put">
	    <div class="form-group row">
          <form:label path="user.firstName" class="col-sm-2 col-form-label">Owner:</form:label>
          <div class="col-sm-10">
            <form:input
              type="text"
              path="user.firstName"
