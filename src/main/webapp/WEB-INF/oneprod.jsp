  ...
  <body>
    <nav>
      <div class="menu">
        ...
        <h1 style="font-family: Poppins, sans-serif;">Product details</h1>
    <div class="left d-inline-block">
      <img src="<c:out value="${product.image}"/>" />
    </div>
    <div class="right d-inline-block">
      <h2><c:out value="${product.name}"/></h2>
      <h5><a href="/stores/${product.store.id}"><c:out value="${product.store.name}"/></a></h5>
       <h5><c:out value="${product.description}"/></h5>
      <h5>$<c:out value="${product.price}"/></h5>
	<form:form method="post" action="/addToBasket/${product.getId() }" modelAttribute="orderProduct" id="quantform">
