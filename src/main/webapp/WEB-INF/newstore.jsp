...
<html lang="en">
  ...
  <body>
    ...
    <form:form method="POST" action="/addstore" modelAttribute="storeobj">
      <div class="form-group row">
        <form:label path="name" class="col-sm-2 col-form-label">Shop name:</form:label>
        <div class="col-sm-10">
          <form:input
            type="text"
            class="form-control"
      ...
      <div class="form-group row">
            <form:label path="description" class="col-sm-2 col-form-label">Shop description:</form:label>
            <div class="col-sm-10">
              <form:input
                type="text"
                path="description"
      ...
      <div class="form-group row">
        <form:label path="location" class="col-sm-2 col-form-label"
          >Shop location:</form:label
        >
        <div class="col-sm-10">
          <form:input
            type="text"
      ...
      <div class="form-group row">
            <div class="col-sm-10">
              <button type="submit" class="btn btn-secondary btn-lg btn-block">Create shop!</button>
            </div>
      </div>
    </form:form>
    <a href="/product/new">Or add a product to your store.</a>
</div>  
    <script
